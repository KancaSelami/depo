...
public class Main {
    ...
    //    catagoryManager.add(catagory2);
        ...
        Course course=new Course(11,"Futbol",1200,catagory);
        Course course1=new Course(12,"Basketbol",1500,catagory);
     //   Course course2=new Course(22,"basketbol",1500);
        List<Course>courses=new ArrayList<>();
        //asagida kursun katagoriside olacagindan kursu katagoriye kaydediyoruz.
        CourseManager courseManager=new CourseManager(new JdbcCourseDao(),courses,iloggers,catagory);
